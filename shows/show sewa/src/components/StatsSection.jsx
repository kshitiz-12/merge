...
const stats = [
  ...
  {
    icon: <FaUsers className="text-3xl text-brand-primary mb-2" />,
    value: "25,000+",
    label: "Happy Customers",
  },
  {
    icon: <FaMapMarkerAlt className="text-3xl text-brand-primary mb-2" />,
    value: "15+",
    label: "Cities Covered",
  },
  {
    icon: <FaCalendarAlt className="text-3xl text-brand-primary mb-2" />,
    value: "5+",
