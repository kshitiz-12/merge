...
const About = () => (
  <section className="py-16 bg-brand-cream min-h-[60vh]">
    <div className="max-w-4xl mx-auto px-4">
      <h1 className="text-3xl font-bold text-brand-maroon mb-8">
      ...
      <h2 className="text-2xl font-semibold text-brand-gold mb-4">Our Team</h2>
      <ul className="list-disc pl-6 text-brand-dark">
